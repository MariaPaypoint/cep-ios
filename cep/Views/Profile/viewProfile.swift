            ...
            ScrollView {
                VStack {
                    ...
                    VStack {
                        ...
                        builBlueText("ведь Бог меняет изнутри каждого человека, а хорошие люди делают и весь мир лучше.")
                            .padding(.bottom, 6)
                        builBlueText("Команда работает над проектом благодаря участию неравнодушных людей.\nАвторы курсов также нуждаются в поддержке, которая позволяет им создавать качественный бесплатный христианский образовательный контент.")
                            .padding(.bottom, 13)
                        ...
                        Button() {
                            ...
                            HStack {
                                ...
                                Text("Посмотрите, на что и чем можно помочь")
                                    .font(.subheadline)
                            }
                            .foregroundColor(.white)
                            .padding(.vertical, 12)
